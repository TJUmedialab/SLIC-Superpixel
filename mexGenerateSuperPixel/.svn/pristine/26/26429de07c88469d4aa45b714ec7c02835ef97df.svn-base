...
// Edit list:
// 1. modify the EnforceLabelConnectivity function as a virtual function
// 2. comment all the functions related to super voxel.
// 3. parameters in DoSuperpixelSegmentation_ForGivenSuperpixelSize, DoSuperpixelSegmentation_ForGivenNumberOfSuperpixels
//                  PerformSuperpixelSLIC, from int*& to int*, so the user must allocate the memory outside the function
