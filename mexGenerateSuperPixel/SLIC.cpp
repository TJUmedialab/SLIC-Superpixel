...
// Edit list:
// 1. comment all the function related to super voxel
// 2. change the parameters (refer to the header file)
// 3. all the new operator is moved to the caller function
